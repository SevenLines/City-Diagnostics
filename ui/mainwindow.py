...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(2, _translate("MainWindow", "Сгенерировать docx (состояние участков в баллах)"))
        self.comboBox.setItemText(3, _translate("MainWindow", "Сгенерировать docx (соответствие состояния)"))
        self.comboBox.setItemText(4, _translate("MainWindow", "Сгенерировать карты (*.png)"))
        self.comboBox.setItemText(5, _translate("MainWindow", "Сгенерировать json"))
